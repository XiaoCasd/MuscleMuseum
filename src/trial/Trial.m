classdef (Abstract) Trial < handle & matlab.mixin.SetGetExactNames & dynamicprops
    ...
    methods
        function obj = Trial(trialName,config)
            ...
            % ----------
            % trialName : string
            %     Alphanumeric name for the trial type.
            % config : string | table | struct
            %     Configuration identifier or data. If string, loads from ``Config.mat``.
            %
            % Returns
            % -------
            % obj : Trial
        ...
        function displayLog(obj,str,logType)
            ...
            %     One of ``"normal"``, ``"warning"``, or ``"error"``.
            %
            % Returns
            % -------
            % None
    ...
    methods
        ...
        function isCompeted = get.IsCompeted(obj)
            ...
            % -------
            % isCompeted : logical
            %     True if :attr:`NRun` equals :attr:`NCompletedRun`.
        ...
        function is2DScan = get.Is2DScan(obj)
            ...
            % -------
            % is2DScan : logical
            %     True if :attr:`ScannedParameter` is a 1x2 string array.
